...
public class activity_monitoring_screen extends AppCompatActivity {
    private static final String TAG = "CovitorWatch";
    final static String temperature="23";
    ...
    private class ReadInput implements Runnable {
        ...
        public void run() {
            ...
            try {
                Thread.sleep(2000);
                try {
                    mBTSocket.getOutputStream().write(temperature.getBytes());
                } catch (IOException e) {
                    e.printStackTrace();
                }
...
// TODO Auto-generated method stub
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void> {
        ...
        @Override
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(activity_monitoring_screen.this, "Hold on", "Connecting");
        }
        @Override
