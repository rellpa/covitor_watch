...
public class activity_monitoring_heart extends AppCompatActivity {
    private static final String TAG = "CovitorWatch";
    final static String heartrate="24";
    private int mMaxChars = 50000;
    private UUID mDeviceUUID;
    private BluetoothSocket mBTSocket;
    private activity_monitoring_heart.ReadInput mReadThread = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitoring_heart);
    ...
    private class ReadInput implements Runnable {
        ...
        public void run() {
            ...
            try {
                Thread.sleep(2000);
                try {
                    mBTSocket.getOutputStream().write(heartrate.getBytes());
                } catch (IOException e) {
                    e.printStackTrace();
                }
    ...
    protected void onPause() {
        if (mBTSocket != null && mIsBluetoothConnected) {
            new activity_monitoring_heart.DisConnectBT().execute();
        }
        Log.d(TAG, "Paused");
        super.onPause();
    }
    ...
    protected void onResume() {
        if (mBTSocket == null || !mIsBluetoothConnected) {
            new activity_monitoring_heart.ConnectBT().execute();
        }
        Log.d(TAG, "Resumed");
        super.onResume();
    }
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void> {
        ...
        @Override
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(activity_monitoring_heart.this, "Hold on", "Connecting");
        }
